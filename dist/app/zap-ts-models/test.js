...
const zap_error_result_3 = require("./zap-error-result");
var toZapError = zap_error_result_1.ErrorConvert.toZapError;
class Test {
    constructor() {
        let data = '{"code": 6667, "message": "error-getting-item"}';
        let errData = zap_error_result_2.GetZapError(data);
    ...
    tryData(data) {
        ...
        return errData instanceof zap_error_result_3.ZapErrorResult;
    }
}
exports.Test = Test;
...
if (args[0] === "test") {
    ...
    let cp2 = zap_error_result_2.GetZapError(objData);
