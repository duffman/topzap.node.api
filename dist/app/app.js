...
const zyn_socket_server_1 = require("@igniter/coldmind/zyn-socket.server");
...
const analytics_ws_api_controller_1 = require("@api/ws/analytics-ws-api.controller");
const zappy_app_settings_1 = require("@app/zappy.app.settings");
const path = require("path");
const socketSession = require("socket.io-mysql-session");
...
*/
    constructor(includeMinerApi = false) {
        ...
        this.wsServer = new zyn_socket_server_1.SocketServer();
    ...
    initWsControllers() {
        ...
        controllers.push(new analytics_ws_api_controller_1.AnalyticsWsApiController(this.debugMode));
        //
    ...
    configureWebServer() {
        ...
        routes.use(this.sessionMiddleware);
        routes.use(cookieParser(zappy_app_settings_1.Settings.sessionSecret));
        routes.use(bodyParser.json()); // support json encoded bodies
        routes.use(bodyParser.urlencoded({ extended: true })); // support encoded bodies
        let allowCrossDomain = (req, res, next) => {
            ...
            res.header("Access-Control-Allow-Origin", zappy_app_settings_1.Settings.allowedCORSOrigins);
