...
const basket_api_controller_1 = require("@app/components/basket/basket-api.controller");
...
*/
    ...
    initControllers() {
        ...
        let searchApiControler = new search_api_controller_1.SearchApiController(this.debugMode);
