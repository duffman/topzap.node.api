...
const session_pull_result_1 = require("@zapModels/session-pull-result");
const api_routes_1 = require("@api/api-routes");
const basket_item_model_1 = require("@app/zap-ts-models/basket-item.model");
const basket_model_1 = require("@app/zap-ts-models/basket.model");
const basket_add_result_1 = require("@app/zap-ts-models/basket-add-result");
...
class BasketApiController {
    ...
    validateSessionBasket(sessionBasket = null) {
        ...
        result = basketSess !== null && (basketSess instanceof basket_collection_1.SessionBasket);
        return result;
    }
    /**
    ...
    addToBasket(code, offerData) {
        ...
        for (let i = 0; i < offerData.vendors.length; i++) {
            ...
            let vendorOffer = parseFloat(vendor.offer);
            let resultItem = new basket_item_model_1.BasketItem(prand_num_1.PRandNum.randomNum(), code, vendor.vendorId, vendor.title, vendorOffer);
    ...
    apiAddBasketItem(req, resp) {
        ...
        function doAdd() {
            return __awaiter(this, void 0, void 0, function* () {
                let addRes = yield scope.addProductInfoToSession(code);
                console.log("%%%%% ::: addRes :::", addRes);
                let searchResult = yield scope.callSearchService(code);
    ...
    apiPullSession(req, resp) {
        ...
        try {
            ...
            try {
                let tmpSessionBasket = new basket_collection_1.SessionBasket();
