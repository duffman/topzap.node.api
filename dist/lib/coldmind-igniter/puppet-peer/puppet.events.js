...
(function (PuppetEvents) {
    let Client;
    (function (Client) {
        Client.Connect = "connect"; // Fired upon a successful conn
        Client.ConnectError = "connect_error"; // Fired upon a conn error
        Client.ConnectTimeout = "connect_timeout"; // Fired upon a conn timeout
