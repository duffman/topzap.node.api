 ...
 */
const session_igniter_entry_1 = require("../app/components/session-igniter/session-igniter-entry");
let sessEntry = new session_igniter_entry_1.SessionEntry("balle", { kalle: "kula" });
