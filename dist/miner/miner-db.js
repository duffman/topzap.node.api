...
class MinerDb {
    ...
    haveMinerSession(vendorId) {
        ...
        return new Promise((resolve, reject) => {
            return this.db.dbQuery(sql).then((dbRes) => {
                ...
                cli_logger_1.Logger.logError("getMinerSession :: error ::", error);
                reject(error);
            });
        });
    }
    ...
    getWorkQueue(sessionId, size = -1) {
        ...
        return new Promise((resolve, reject) => {
            return this.db.dbQuery(sql).then((dbRes) => {
                ...
                cli_logger_1.Logger.logError("getWorkQueue :: error ::", error);
                reject(error);
            });
        });
    }
    ...
    updateWorkQueue(item) {
        ...
        cli_logger_1.Logger.logGreen("updateWorkQueue :: sql ::", sql);
        return new Promise((resolve, reject) => {
            return this.db.dbQuery(sql).then((dbRes) => {
                resolve(dbRes);
            }).catch((error) => {
    ...
    createMinerSession(vendorId, minerName = "<noname>") {
        ...
        return new Promise((resolve, reject) => {
            return this.db.dbQuery(sql).then((dbRes) => {
                ...
                cli_logger_1.Logger.logError("createMinerSession", error);
                reject(error);
            });
        });
    }
    ...
    setSessionDone(sessionId, vendorId) {
        ...
        return new Promise((resolve, reject) => {
            return this.db.dbQuery(sql).then((dbRes) => {
                ...
                cli_logger_1.Logger.logError("setSessionDone", error);
                reject(error);
            });
        });
    }
